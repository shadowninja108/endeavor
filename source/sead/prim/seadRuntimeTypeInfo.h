...
public:                                                                                            \
    ...
    {                                                                                              \
        DO_PRAGMA(GCC visibility push(protected))                                                  \
        static const sead::RuntimeTypeInfo::Root typeInfo;                                         \
        DO_PRAGMA(GCC visibility pop)                                                              \
        return &typeInfo;                                                                          \
    }                                                                                              \
                                                                                                   \
...
#define SEAD_RTTI_BASE_GETTER(CLASS)                                                               \
    virtual const sead::RuntimeTypeInfo::Interface* CLASS::getRuntimeTypeInfo() const              \
    {                                                                                              \
        return getRuntimeTypeInfoStatic();                                                         \
    }

#define SEAD_RTTI_BASE_WIMPL(CLASS, BASE)   \
    SEAD_RTTI_BASE(CLASS, BASE)             \
    SEAD_RTTI_BASE_IMPL(CLASS, BASE)
...
#define SEAD_RTTI_OVERRIDE_IMPL(CLASS, BASE)                                                       \
    const sead::RuntimeTypeInfo::Interface* CLASS::getRuntimeTypeInfo() const                      \
    {                                                                                              \
        return getRuntimeTypeInfoStatic();                                                         \
    }
