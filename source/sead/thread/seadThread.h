...
{
    public:
    DelegateThread(sead::SafeString const&, sead::IDelegate2<Thread*, MessageQueue::Element>*, sead::Heap*, int, MessageQueue::BlockType, MessageQueue::Element, int, int);

    private:
    sead::IDelegate2<Thread*, long>* mDelegate;
